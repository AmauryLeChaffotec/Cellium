...
const formulaCatalog: { title: string; formulas: FormulaInfo[] }[] = [
  {
    ...
    formulas: [
      { name: 'SUM', syntax: '=SUM(A1:A10)', desc: 'Somme des valeurs', template: '=SUM()' },
      { name: 'AVERAGE', syntax: '=AVERAGE(A1:A10)', desc: 'Moyenne des valeurs', template: '=AVERAGE()' },
      { name: 'MIN', syntax: '=MIN(A1:A10)', desc: 'Valeur minimale', template: '=MIN()' },
      { name: 'MAX', syntax: '=MAX(A1:A10)', desc: 'Valeur maximale', template: '=MAX()' },
      { name: 'COUNT', syntax: '=COUNT(A1:A10)', desc: 'Nombre de valeurs numeriques', template: '=COUNT()' },
      { name: 'COUNTA', syntax: '=COUNTA(A1:A10)', desc: 'Nombre de cellules non vides', template: '=COUNTA()' },
      { name: 'COUNTBLANK', syntax: '=COUNTBLANK(A1:A10)', desc: 'Nombre de cellules vides', template: '=COUNTBLANK()' },
      { name: 'MEDIAN', syntax: '=MEDIAN(A1:A10)', desc: 'Mediane des valeurs', template: '=MEDIAN()' },
